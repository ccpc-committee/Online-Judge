...
<thead>
<tr class=toprow><th><th style="text-align:center">AC<th style="text-align:center">PE<th style="text-align:center">WA<th style="text-align:center">TLE<th style="text-align:center">MLE<th style="text-align:center">OLE<th style="text-align:center">RE<th style="text-align:center">CE<th style="text-align:center"><th style="text-align:center">TR<th style="text-align:center">Total
<?php 
  $i=0;
  foreach ($language_name as $lang){
	if(isset($R[$pid_cnt][$i+11]))	
		echo "<th class='center' width='8%' style='text-align:center'>$language_name[$i]</th>";
	else
		echo "<th class='center' style='text-align:center'>";
	$i++;
  }
...
if ($i&1)
echo "<tr align=center class=oddrow style='text-align:center'><td>";
else
