...
<tr ><td><?php echo $MSG_SOVLED?><td align=center><?php echo $AC?></a>
...
<tr ><td><?php echo $MSG_SUBMIT?><td align=center><?php echo $Submit?></a></tr>
<?php
foreach($view_userstat as $row){
//i++;
echo "<tr ><td>".$jresult[$row[0]]."<td align=center>".$row[1]."</tr>";
}
//}
