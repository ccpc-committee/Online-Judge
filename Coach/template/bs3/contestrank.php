...
<html lang="en">
  <head>
    ...
    <title><?php echo $OJ_NAME."&nbsp;&nbsp;&nbsp;&nbsp;"."教练"?></title>  
...
<table id=rank width="100%"><thead><tr class=toprow align=center><td class="{sorter:'false'}" width=5% style="text-align:center">Rank<th width=8% style="text-align:center">User</th><th width=10% style="text-align:center">Nick</th><th width=5% style="text-align:center">Solved</th><th width=5% style="text-align:center">Penalty</th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
echo "<td>$PID[$i]</td>";
echo "</tr></thead>\n<tbody>";
