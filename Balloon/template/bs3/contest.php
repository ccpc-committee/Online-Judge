...
<html lang="en">
  <head>
    ...
    <title><?php echo $OJ_NAME."&nbsp;&nbsp;&nbsp;&nbsp;"."气球"?></title>  
...
echo "    <span class=red style='color:blue'>Running</span>";
?>&nbsp;&nbsp;
...
<td width="10%" style="cursor:hand" onclick="sortTable('problemset', 1, 'int');" ><?php echo $MSG_PROBLEM_ID?>
<td width='50%'><?php echo $MSG_TITLE?></td>
<!--<td width='10%'><?php echo $MSG_SOURCE?></td>-->
<td style="cursor:hand;text-align:center" onclick="sortTable('problemset', 4, 'int');" width='10%'><?php echo $MSG_AC?></td>
<td style="cursor:hand" onclick="sortTable('problemset', 5, 'int');" width='10%'><?php echo $MSG_SUBMIT?></td>
</tr>
</thead>
<tbody>
<?php
