...
<table id=rank width="100%"><thead><tr class=toprow align=center><td class="{sorter:'false'}" width=3% style="text-align:center">Rank<th width=5% style="text-align:center">User</th><th width=5% style="text-align:center">Nick</th><th width=3% style="text-align:center">Solved</th><th width=5% style="text-align:center">Penalty</th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
...
echo "*";
$usolved=$U[$i]->solved;
if(isset($_GET['user_id'])&&$uuid==$_GET['user_id']) echo "<td bgcolor=#ffff00>";
else echo"<td>";
echo "$uuid";
echo "<td>".htmlentities($U[$i]->nick,ENT_QUOTES,"UTF-8");
echo "<td>$usolved";
