...
if(
				...
				//$profile.= "&nbsp;<li><a  class='glyphicon glyphicon-envelope' href=".$path_fix."mail.php>$mail</a></li>";
				$profile.= "&nbsp;<li><a style='margin-top:-17px' href=".$path_fix."logout.php>$MSG_LOGOUT</a></li>&nbsp;";
			}else{
                if ($OJ_WEIBO_AUTH){
           ...
           $profile.= "<li><a style='background:yellow' href=".$path_fix."admin/>$MSG_ADMIN</a></li>&nbsp;";
			
			}
			if (isset($_SESSION[$OJ_NAME.'_'.'balloon'])){
           $profile.= "<li><a style='background:yellow' href='".$path_fix."balloon.php'>$MSG_BALLOON</a></li>&nbsp;";
			}
	 //  $profile.="</ul></li>";
		?>
