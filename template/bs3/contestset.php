...
<center><form method=post action=contest.php >
	...
	<input type=submit>
</form>ServerTime:<span id=nowdate></span><p>
<table class='table table-striped' width=90%>
<thead>
<tr class=toprow align=center><td width=10%>ID<td width=40%>Name<td width=30%>Status<td width=10%>Private<td>Creator</tr>
</thead>
<tbody>
<?php
$cnt=0;
