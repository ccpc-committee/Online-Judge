...
static  $OJ_RANK_LOCK_PERCENT=0.2; //比赛封榜时间比例
...
require_once(dirname(__FILE__)."/pdo.php");
	...
	pdo_query("set @@global.sql_mode ='STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';");
